...
milestone: M6c — Run Complete Correction
priority: P1
estimate: S
wave: W0
depends_on: []
...
- It ships as its own PR, ahead of M7's face tiles, so it is its own
  milestone, `M6c` (roadmap: "Why M6 was split a third time"). M7 stays one
  milestone and one PR.
